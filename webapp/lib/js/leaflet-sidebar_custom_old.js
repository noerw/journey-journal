L.Control.Sidebar = L.Control.extend({
    ...
    addPanel: function(id, tabContent, panelContent) {
        // create HTML elements & append them to the DOM
        var contentHTML = L.DomUtil.create('DIV', 'sidebar-pane', this._container);
        contentHTML.id = id;
        contentHTML.innerHTML = panelContent;

        var tabHTML = L.DomUtil.create('LI', '', this._tabs);
        L.DomUtil.create('A', '', tabHTML);
        tabHTML.firstChild.href = '#' + id;
        tabHTML.firstChild.role = 'tab';
        tabHTML.firstChild.innerHTML = tabContent;

        //register click listener
        L.DomEvent.on(tabHTML.firstChild, 'click', this._onClick, tabHTML);

        // add them to internal arrays
        tabHTML._sidebar = this;
